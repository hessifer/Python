...
class Gaussian(Distribution):
    ...
    def plot_histogram_pdf(self, n_spaces=50):
        ...
        # mu = self.mean  # not referenced in code
        # sigma = self.stdev  # not referenced in code
    ...
    def read_data_file(self, file_name, sample=True):
        """ Function to read in data from a txt file. The txt file should
            have one number (float) per line. The numbers are stored in
            the data attribute. After reading the file, the mean and standard
