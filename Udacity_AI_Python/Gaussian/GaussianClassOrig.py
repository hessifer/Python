...
class Gaussian():
    ...
    def calculate_stdev(self, sample=True):
        ...
        #
        # The sample variable determines if the data set contains a sample
        # or a population
        # If sample = True, this means the data is a sample.
        # Keep the value of sample in mind for calculating the standard
        # deviation
        #
        # Make sure to update self.stdev and return the standard deviation
        # as well
    ...
    def read_data_file(self, file_name, sample=True):
        ...
        # You can use the calculate_mean() method with
        # self.calculate_mean()
    ...
    def pdf(self, x):
        ...
        # distribution
        # at the value x. You'll need to use self.stdev and self.mean to do
        # the calculation
    ...
    def __add__(self, other):
        ...
        # the
        # square root of the sum of square ie sqrt(
        # stdev_one ^ 2 + stdev_two ^ 2)
        # create a new Gaussian object
        result = Gaussian()

        # TODO: calculate the mean and standard deviation of the sum of
        # two Gaussians
        # NOTE: mean value is the sum of themean values for each Gaussian
